...
<section class="container mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
    ...
    <form method="GET" class="mt-4 w-full">
        <div class="flex">
            <input name="s" type="text" value="<? echo $searchTerm; ?>" class=" w-full rounded-l-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300
            ...
            <tr>
                ...
                <td class="p-4 text-sm text-gray-600">
                    ...
                    <div class="inline-block relative cursor-pointer">
                        <a href="/transaction/<? echo $transaction['id']; ?>/receipt/<? echo $receipt['id'] ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        ...
                        <form action="/transaction/<? echo $transaction['id']; ?>/receipt/<? echo $receipt['id'] ?>"
                            method="POST">
                ...
                <td class="p-4 text-sm text-gray-600 flex justify-center space-x-2">
                    <a href="/transaction/<? echo $transaction['id']; ?>/receipt"
                    ...
                    <a href="/transaction/<? echo $transaction['id']; ?>"
                    ...
                    <form method="POST" action="/transaction/<? echo $transaction['id']; ?>">
                        <input type="hidden" name="_METHOD" value="DELETE" />
                        <?php include $this->resolve("partials/_csrf.php"); ?>
                        <button type="submit"
    ...
    <nav class="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0 mt-6">
        ...
        <div class="-mt-px flex w-0 flex-1">
            <? if ($currentPage > 1) : ?>
            <a href="/?<? echo $previouPageQuery; ?>" class="inline-flex items-center border-t-2 border-transparent pr-1 pt-4 text-sm font-medium
        ...
        <div class="hidden md:-mt-px md:flex">
            ...
            <a href="/?<? echo $query; ?>" class="<? echo $pageNum + 1 === $currentPage ? " border-indigo-500
                text-indigo-600" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300" ; ?>
